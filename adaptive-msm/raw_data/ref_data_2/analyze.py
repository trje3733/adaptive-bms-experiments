...
if __name__ == '__main__':
    ...
    fns = ['trajectory-%s.dcd'%(i) for i in range(10)]
    ...
    for it in range(100):
        ...
        f = open('microstate_info-%s.txt'%(it+1),'w')
        ...
        f.write('\nLeft eigenvectors\n\n')
        for val in pcca.left_eigenvectors_:
            f.write(str(val) + '\n')

        f.write('\nRight eigenvectors\n\n')
        for val in pcca.right_eigenvectors_:
            f.write(str(val) + '\n')
